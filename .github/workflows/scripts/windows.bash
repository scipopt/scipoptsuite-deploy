pacman -S --noconfirm unzip git mingw-w64-x86_64-cmake cmake mingw-w64-x86_64-zlib zip mingw-w64-x86_64-boost mingw-w64-x86_64-gmp
...
mkdir scip_install/pkgconfig
mkdir scip_install/include
mv D:/a/_temp/msys64/mingw/include/gmp.h scip_install/include
mv D:/a/_temp/msys64/mingw/lib/libgmp.a scip_install/lib/.
mv D:/a/_temp/msys64/mingw/pkgconfig/gmp.pc scip_install/pkgconfig/.
...
mkdir soplex_build
cmake -G "Visual Studio 17 2022" -B soplex_build -DCMAKE_INSTALL_PREFIX=../scip_install -DCMAKE_BUILD_TYPE=Release -DPAPILO=false -DGMP=true -DGMP_DIR=../scip_install -DBoost=true -DZLIB=false -DCMAKE_GENERATOR_PLATFORM=x64
...
#mkdir scip_build
#cmake -G "Visual Studio 17 2022" -B scip_build -DCMAKE_INSTALL_PREFIX=../scip_install -DCMAKE_BUILD_TYPE=Release -DLPS=spx -DSYM=none -DSOPLEX_DIR=../scip_install -DPAPILO=false -DZIMPL=false -DZLIB=false -DREADLINE=false -DGMP=true -DIPOPT=true -DIPOPT_DIR=../scip_install -DIPOPT_LIBRARIES=../scip_install/bin -DBoost=true -DCMAKE_GENERATOR_PLATFORM=x64
