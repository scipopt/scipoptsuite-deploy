...
make config  
CONFIG_FLAGS="-DCMAKE_VERBOSE_MAKEFILE=1 -DCMAKE_POLICY_VERSION_MINIMUM=3.5 -DCMAKE_INSTALL_PREFIX=$GITHUB_WORKSPACE/GKlib-METIS-v5.1.1-DistDGL-0.5"
make
make install
...
make config
CONFIG_FLAGS="-DCMAKE_VERBOSE_MAKEFILE=1 -DCMAKE_POLICY_VERSION_MINIMUM=3.5 -DCMAKE_INSTALL_PREFIX=$GITHUB_WORKSPACE/metis/ -DGKLIB_PATH=$GITHUB_WORKSPACE/GKlib-METIS-v5.1.1-DistDGL-0.5"
make
make install
